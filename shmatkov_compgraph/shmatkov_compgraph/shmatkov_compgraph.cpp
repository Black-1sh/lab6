...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(shaderProgram, "material.ambient"), 0.5f, 0.5f, 1.0f);
        glUniform3f(glGetUniformLocation(shaderProgram, "material.diffuse"), 0.5f, 0.5f, 1.0f);
        glUniform3f(glGetUniformLocation(shaderProgram, "material.specular"), 0.5f, 0.5f, 1.0f);
